...
export default function AppointmentAdmin({
  ...
  return (
    <Html lang="fr">
      <Head />
      <Preview>
        Nouveau rendez-vous — {firstName} {lastName}
      </Preview>
      <Body style={body}>
        <Container style={container}>
          <Heading style={heading}>Nouveau rendez-vous</Heading>
          <Hr style={divider} />
          <Text style={badge}>Référence #{appointmentId}</Text>
